...
export declare class ErrorFromResponse<T> extends Error {
    ...
    name: string;
    unrecoverable: boolean | null;
    constructor({ message, code, status, response, unrecoverable, }: Pick<ErrorFromResponse<T>, 'message' | 'code' | 'status' | 'response' | 'unrecoverable'>);
    toJSON(): {
        message: string;
...
export type AllClientCallEvents = {
    [K in EventTypes]: Extract<StreamVideoEvent, {
        type: K;
    }>;
};
