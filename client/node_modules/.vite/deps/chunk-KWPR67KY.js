...
var WebGLRenderer = class _WebGLRenderer {
      ...
      if (newSource.type === "image") {
        ...
        const writer = new WritableStream({
          write(videoFrame) {
            ...
            ctx == null ? void 0 : ctx.drawImage(videoFrame, 0, 0);
            videoFrame.close();
          },
          close() {
  ...
  render(videoFrame, options, categoryTexture, confidenceTexture) {
    ...
    if (options.bgBlur > 0 && options.bgBlurRadius > 0) {
      ...
      backgroundTexToUse = ((_a2 = this.backgroundRenderInfo) == null ? void 0 : _a2.texture) ?? null;
    }
    gl.bindFramebuffer(gl.FRAMEBUFFER, null);
    gl.viewport(0, 0, gl.drawingBufferWidth, gl.drawingBufferHeight);
    gl.useProgram(blendProgram);
  ...
  close() {
    ...
    if ((_a2 = this.backgroundRenderInfo) == null ? void 0 : _a2.texture) {
      gl.deleteTexture(this.backgroundRenderInfo.texture);
      this.backgroundRenderInfo = null;
    }
    this.activeBackgroundSourceIdentifier = null;
...
var FallbackGenerator = class {
  constructor({ kind, signalTarget }) {
    ...
    const height = signalTarget == null ? void 0 : signalTarget.getSettings().height;
    const width = signalTarget == null ? void 0 : signalTarget.getSettings().width;
    if (height && width) {
...
var BaseVideoProcessor = class {
    ...
    const transformStream = new TransformStream({
      transform: async (frame, controller) => {
        ...
        try {
          ...
          (_b = (_a2 = this.hooks).onError) == null ? void 0 : _b.call(_a2, e2);
        } finally {
          frame.close();
        }
      },
  ...
  updateStats(delay) {
    ...
    if (now - this.lastStatsTime >= 1e3) {
      ...
      (_b = (_a2 = this.hooks).onStats) == null ? void 0 : _b.call(_a2, { delay: avgDelay, fps, timestamp: now });
      this.frames = 0;
      this.delayTotal = 0;
      this.lastStatsTime = now;
    }
...
var VirtualBackground = class extends BaseVideoProcessor {
  ...
  async initializeSegmenter() {
    try {
      ...
      const model = this.options.modelPath || `${basePath}/models/selfie_segmenter_landscape.tflite`;
      const fileset = await na.forVisionTasks(`${basePath}/wasm`);
      this.segmenter = await qc.createFromOptions(fileset, {
  ...
  async transform(frame) {
    ...
    const hasNewFrame = currentTime - this.lastFrameTime > 1e3;
  ...
  async runSegmentation(frame) {
    ...
    return new Promise((resolve) => {
      ...
      this.segmenter.segmentForVideo(frame, timestamp, (result) => {
        ...
        try {
          this.latestCategoryMask = (_a2 = result.categoryMask) == null ? void 0 : _a2.getAsWebGLTexture();
          this.latestConfidenceMask = (_c2 = (_b = result.confidenceMasks) == null ? void 0 : _b[0]) == null ? void 0 : _c2.getAsWebGLTexture();
        } catch (err) {
          console.error("[virtual-background] segmentation error:", err);
          (_e2 = (_d = this.hooks).onError) == null ? void 0 : _e2.call(_d, err);
        } finally {
          result.close();
          resolve();
        }
  ...
  async initializeSegmenterOptions() {
    ...
    const strength = typeof blurLevel === "string" ? BACKGROUND_BLUR_MAP[blurLevel] : Math.round(blurLevel ?? 5);
    return {
  ...
  onStop() {
    var _a2;
    (_a2 = this.webGlRenderer) == null ? void 0 : _a2.close();
    this.destroySegmenter();
  }
  destroySegmenter() {
    var _a2;
    (_a2 = this.segmenter) == null ? void 0 : _a2.close();
    this.segmenter = null;
    this.isSegmenterReady = false;
  }
  get processorName() {
...
var FullScreenBlur = class extends BaseVideoProcessor {
  ...
  onStop() {
    var _a2;
    (_a2 = this.blurRenderer) == null ? void 0 : _a2.close();
  }
  get processorName() {
...
//# sourceMappingURL=chunk-KWPR67KY.js.map
